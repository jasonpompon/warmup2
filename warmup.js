// to pick a random string from these 2 arrays then create another string
...
var randName = thisArray[Math.floor(Math.random() * thisArray.length)];

var randDescript = thatArray[Math.floor(Math.random() * thatArray.length)];

console.log("My startup is " + randName + " what is does is " + randDescript);
